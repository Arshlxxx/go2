...
#just for go2, if run another example, pls use the original path
ISAACLAB_NUCLEUS_DIR = f"omniverse://localhost/Library/Asset/isaac-sim-assets-2-4.2.0/Assets/Isaac/4.2/Isaac"
