...
UNITREE_GO2_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        #usd_path=f"omniverse://localhost/Library/Asset/isaac-sim-assets-2-4.2.0/Assets/Isaac/4.2/Isaac/Robots/Unitree/Go2/go2.usd",#go2_with_z1.usd
        #usd_path=f"{ISAACLAB_NUCLEUS_DIR}/Robots/Unitree/Go2/go2.usd",#go2_with_z1.usd
        usd_path=f"/home/robotic/Downloads/isaac-sim-assets-2-4.2.0/Assets/Isaac/4.2/Isaac/IsaacLab/Robots/Unitree/Go2/go2.usd",
...
UNITREE_GO2andZ1_CFG = ArticulationCfg(
   spawn=sim_utils.UsdFileCfg(
        #usd_path=f"omniverse://localhost/Library/Asset/isaac-sim-assets-2-4.2.0/Assets/Isaac/4.2/Isaac/Robots/Unitree/Go2/go2.usd",  # 修改后的USD文件路径
        usd_path=f"/home/robotic/Downloads/isaac-sim-assets-2-4.2.0/Assets/Isaac/4.2/Isaac/IsaacLab/Robots/Unitree/Go2/go2withz1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
#     spawn=sim_utils.UsdFileCfg(
#         usd_path=f"omniverse://localhost/Library/Asset/isaac-sim-assets-2-4.2.0/Assets/Isaac/4.2/Isaac/Robots/Unitree/Z1/z1.usd",
...
"""Configuration for the Unitree Z1 robot arm."""
